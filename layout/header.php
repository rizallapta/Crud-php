    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index.php" class="brand-link">
                ...
                <span class="brand-text font-weight-light">CRUD PHP <small>By Rizal</small></span>
            </a>

            <!-- Sidebar -->
            <div class="sidebar">
            <div class="sidebar">
    <!-- Sidebar user panel pertama -->
    <div class="user-panel mt-3 pb-3 mb-3 d-flex align-items-center">
        <div class="image">
            <img src="assets-template/dist/img/fotoGua.png" class="img-circle elevation-3" alt="User Image" style="width: 50px;">
        </div>
        <div class="info">
            <a href="#" class="d-block">Rizal</a>
        </div>
    </div>
    <div class="user-panel mt-3 pb-3 mb-3 d-flex align-items-center">
        <div class="image">
            <img src="assets-template/dist/img/qqqq.png" class="img-circle elevation-3" alt="User Image" style="width: 50px;">
        </div>
        <div class="info">
            <a href="#" class="d-block">Ardan</a>
        </div>
    </div>
